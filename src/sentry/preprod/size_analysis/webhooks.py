...
from sentry.sentry_apps.utils.webhooks import BuildUploadActionType
...
def send_size_analysis_webhook(
    ...
    try:
        ...
        broadcast_webhooks_for_organization.delay(
            resource_name="build_upload",
            event_name=BuildUploadActionType.SIZE_ANALYSIS_COMPLETED.value,
